...
public final class AudioRoutingManager {
    ...
    public func getActiveAudioSources() -> [AudioSource] {
        ...
        for source in detected {
            ...
            merged.followsSystemOutput = route.routeMode == .followSystem
    ...
    public func assignOutputDevice(sourceID: String, deviceID: String) {
        ...
        do {
            ...
            lastWarning = "True per-app routing requires an audio routing driver. AudioRouter saved the route preference."
        }
    }
    ...
    public func setSourceVolume(sourceID: String, volume: Double) {
        ...
        do {
            ...
            lastWarning = "Per-app volume is saved, but real per-app gain requires an audio routing driver."
        }
    }
    ...
    public func muteSource(sourceID: String, muted: Bool) {
        ...
        do {
            ...
            lastWarning = "Per-app mute is saved, but real per-app mute requires an audio routing driver."
        }
    }
    ...
    public func handleDeviceDisconnected(deviceID: String) {
        let affected = routesBySourceID.values.filter { $0.outputDeviceID == deviceID && $0.routeMode == .customDevice }
    ...
    public func deviceName(for route: AudioRoute, outputs: [AudioDevice]) -> String {
        guard route.routeMode == .customDevice, let outputDeviceID = route.outputDeviceID else {
